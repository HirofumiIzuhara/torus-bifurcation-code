...
p=[]; lx=0.5; nx=100;
par=[1.0; 1.0; 0.05; 0.19; 0.1; 1.0]; % alpha, L, Du, Dv, A, B
...
p=cont(p,120);
%% Steady bifurcations from constant steady state 
p=swibra('case1-1/hom','bpt3','case1-1/b3-1',0.01); 
p.nc.ilam=3;
p.nc.dsmax=0.01;
p.nc.lammin=0.005; 
p=cont(p,120);
%% Steady bifurcations from constant steady state 
p=swibra('case1-1/hom','bpt3','case1-1/b3-2',-0.01); 
p.nc.ilam=3;
p.nc.dsmax=0.01;
p.nc.lammin=0.005; 
p=cont(p,120);
...
%aux=[]; aux.tl=70;
%p=hoswibra('case-6_1/hom-peri','hpt1',0.1,4,'case-6_1/hom-peri-1',aux); 
%p.hopf.jac=1;
%p.nc.dsmax=0.5; 
%p.hopf.xi=0.05;
%p.usrlam=0.63;
...
plotbra('case1-1/b3-1',3,1,'lsw',0,'cl','b');
plotbra('case1-1/b3-2',3,1,'lsw',0,'cl','b');
%plotbra('case-3_1/b3-1',3,1,'lsw',0,'cl','b');
%plotbra('case-3_1/b3-2',3,1,'lsw',0,'cl','b');
...
plotsol('case1-1/b1-2','pt40',1,[1,2],[1,2]);
