...
p=[]; lx=0.5; nx=100;
par=[0.47; 1.0; 0.06; 1.0; 10.0; 4.0]; % alpha, L, Du, Dv, A, B
...
aux=[]; aux.tl=150;
p=hoswibra('case1-1/b1-2','hpt2',0.01,4,'case1-1/b1-1-h1',aux); 
%figure(2); clf;
p.plot.pmod = 1;
p.hopf.jac=1;
p.nc.dsmax=0.1; 
...
plotbra('case1-1/b1-2',3,1,'lsw',0,'cl','c');
...
plotbra('case1-1/b1-1-h1',3,1,'lsw',0,'cl','m');
